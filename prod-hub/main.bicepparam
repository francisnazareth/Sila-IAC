...
param managementSubnetAddressPrefix = '192.168.53.208/28'
param sharedServicesSubnetAddressPrefix = '192.168.53.224/28'
...
param logAnalyticsWorkspaceName  = 'law-sila-hub-qc-09'
...
param keyVaultName = 'kv-sila-hub-qc-01'
